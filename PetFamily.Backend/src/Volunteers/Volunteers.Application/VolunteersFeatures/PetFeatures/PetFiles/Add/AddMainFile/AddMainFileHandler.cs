...
namespace Volunteers.Application.VolunteersFeatures.PetFeatures.PetFiles.Add.AddMainFile;
...
public class AddMainFileHandler(
    ...
    ILogger<AddMainFileHandler> logger) : ICommandHandler<FilePath, AddPetFileCommand>
{
