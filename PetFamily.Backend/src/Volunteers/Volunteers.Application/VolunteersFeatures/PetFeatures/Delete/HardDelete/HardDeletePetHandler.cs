...
namespace Volunteers.Application.VolunteersFeatures.PetFeatures.Delete.HardDelete;

public class HardDeletePetHandler(
    IFileProvider fileProvider,
    IVolunteersRepository volunteersRepository,
    IValidator<DeletePetCommand> validator,
    ILogger<SoftDeletePetHandler> logger) : ICommandHandler<Guid, DeletePetCommand>
{
